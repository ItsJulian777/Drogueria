...
$SelectUser = ejecutarSQL::consultar("SELECT * FROM cliente ");
        ...
        <main>
            <div class="d-flex container-admin">
                ...
                <div style=" width: 1000px;">
                    ...
                    <table class="table table-bordered  " style="height: 200px; margin: 30px;">
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="text-center"><?php echo $DataUser['NIT']; ?></td>
                                    <td class="text-center"><?php echo $DataUser["Nombre"]; ?></td>
                                    <td class="text-center"><?php echo $DataUser["Apellido"]; ?></td>
                                    <td class="text-center"><?php echo $DataUser["Direccion"]; ?></td>
                                    <td class="text-center"><?php echo $DataUser["Telefono"]; ?></td>
