    ...
    <body>
        ...
        <main>
            <div class="d-flex container-admin">
                <div class="d-flex flex-column flex-shrink-0 p-3 bg-light" style="width:280px; min-height: 120vh; border-right: 0.2px solid rgb(63, 63, 63);">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <div class="container-form-admin">
                                    <h3 class=" text-center">Agregar un producto a la tienda</h3>
                                    <form action="../../Controlador/InicioSesión/Producto.php" method="POST" enctype="multipart/form-data" class="FormCatElec" data-form="save">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-xs-12 col-sm-6 col-md-4">
                                                    <div class="form-group label-floating mb-3">
                                                        ...
                                                        <input class="form-control text-center" type="text" required maxlength="30" name="prod-codigo" placeholder="Codigo Requerido">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-xs-12 col-sm-6 col-md-4">
                                                    <div class="form-group label-floating mb-3">
                                                        ...
                                                        <input type="text" class="form-control text-center" required maxlength="30" name="prod-name" placeholder="Nombre Requerido">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-xs-12 col-sm-6 col-md-4">
                                                    <div class="form-group label-floating mb-3">
                                                        ...
                                                        <input type="text" class="form-control text-center" required name="prod-marca" placeholder="Marca Requerido">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-xs-12 col-sm-6 col-md-4">
                                                    <div class="form-group label-floating mb-3">
                                                        ...
                                                        <input type="text" class="form-control text-center" required name="prod-model" placeholder="Modelo Requerido">
                                                    </div>
                                                </div>
                                                <div class="col-xs-12 col-sm-6 col-md-4">
                                                    <div class="form-group label-floating mb-3">
                                                        <!--<label class="control-label">Precio</label>-->
                                                        <input type="text" class="form-control text-center" required name="prod-price" placeholder="Precio Requerido">
                                                    </div>
                                                </div>
                                                <div class="col-xs-12 col-sm-6 col-md-4">
                                                    <div class="form-group label-floating mb-3">
                                                        <!--<label class="control-label">Descuento (%)</label>-->
                                                        <input type="text" class="form-control text-center" required maxlength="2" pattern="[0-9]{1,2}" name="prod-desc-price" value="0" placeholder="Descuento% Requerido">
                                                    </div>
                                                </div>
                                                <div class="col-xs-12 col-sm-6 col-md-4">
                                                    <div class="form-group label-floating mb-3">
                                                        <!--<label class="control-label">Unidades disponibles</label>-->
                                                        <input type="text" class="form-control text-center" required maxlength="20" pattern="[0-9]{1,20}" name="prod-stock" placeholder="Unidades Requerido">
                                                    </div>
                                                </div>
                                                <hr>    
                                                <div class="col-xs-12">
