...
case 3:
?>
<a href="Paginas/Cuenta.php"><i id="item" class="fas fa-user"></i></a>
<?php
...
?>
                        ...
                        <a href="Paginas/Carrito.php" alt="Carrito"><i id="item" class="fas fa-shopping-cart"></i> </a>
            ...
            <div class="row">
                <div class="col-lg-3 mb-3">
                    ...
                    <ul class="list-unstyled small text-muted">
                        <li class="mb-2" _msthash="1363115" _msttexthash="7235683">Diseñado y construido con todo el
                            amor del mundo por el equipo de tu farmacia y Drogueria mas confiable</li>
                ...
                <div class="col-6 col-lg-2 mb-3">
                    ...
                    <ul class="list-unstyled">
                        ...
                        <li class="mb-2"><a href="/" _msthash="1363791" _msttexthash="346359">Donde encontrarnos</a>
                        </li>
                ...
                <div class="col-6 col-lg-2 mb-3">
                    ...
                    <ul class="list-unstyled">
                        <li class="mb-2"><a href="/" _msthash="1363934" _msttexthash="149942">Cuidado Respiratorio</a>
                        </li>
