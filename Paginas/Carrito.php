...
<head>
    ...
    <link href="../Css/estilo-carrito.css" type="text/css" rel="stylesheet" media="">
    ...
    <header class="main-header">
        <div class="container">
            ...
            <div class="main-header-container">
                ...
                <a href="#" id="face" class="red"> <img id="icono" src="https://th.bing.com/th/id/OIP.lPLk_BPmeSAu1COdk8i8iwHaHa?pid=ImgDet&rs=1" alt="Drogueria el reloj" ><span><i ></i></span></a>
                <a href="#" id="insta" class="red"> <img id="icono" src="https://i0.pngocean.com/files/750/461/292/logo-computer-icons-instagram.jpg" alt="Drogueria el reloj" > <span><i ></i></span></a>
                <a href="#" id="whasa" class="red"> <img id="icono" src="https://th.bing.com/th/id/OIP.8fFvZfU73gxvOshB-XsJRQD6D6?pid=ImgDet&rs=1" alt="Drogueria el reloj" > <span><i ></i></span></a>
          ...
          <div  class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul  class="navbar-nav me-auto mb-2 mb-lg-0">
              ...
              <li class="nav-item dropdown">
                <a  id="letras"class="nav-link dropdown-toggle" href="Productos.html" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                  PRODUCTOS
                </a>
        ...
        <div class="container py-5">
          <div class="row">
            <div class="col-lg-3 mb-3">
              <a class="d-inline-flex align-items-center mb-2 link-dark text-decoration-none" href="/" aria-label="DROGUERIA" _mstaria-label="138918">
                
                <span class="fs-5" _msthash="1416402" _msttexthash="138918">Drogueria</span>
              </a>
              <ul class="list-unstyled small text-muted">
                <li class="mb-2" _msthash="1363115" _msttexthash="7235683">Diseñado y construido con todo el amor del mundo por el equipo de tu farmacia y Drogueria mas confiable</li>
            ...
            <div class="pie"><div class="small text-center text-muted">Copyright &copy; 2021 - Tu Drogueria</div></div> 
          </form>
            </div>
          </div>
        </div>
