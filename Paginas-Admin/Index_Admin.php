...
<html lang="en">
    ...
    <head>
    <?php include '../Enlaces/link-Admin.php'; ?>
    </head>
...
=======
                            <a href="#" class="nav-link link-dark link_sidebar ">
                                <svg xmlns="http://www.w3.org/2000/svg" width="30" height="22" fill="currentColor" class="bi bi-radioactive"
                                     viewBox="0 0 16 16">
                        ...
                        <li>
                            <a href="#" class="nav-link link-dark link_sidebar">
>>>>>>> 07f5080a3e72f9bfaf5d6b14f48c2c32bea7da12
                ...
                <div class="container-info-admin">
                  ...
                  <!-- 
                    <table id="tblUsuarios" class="table table-bordered border-primary">
                        <thead>
                            <tr>
                                <th>Id</th>
                                <th>Asunto</th>
