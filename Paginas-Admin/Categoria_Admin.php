        ...
        <div class="d-flex container-admin">
            <div class="d-flex flex-column flex-shrink-0 p-3 bg-light"
                ...
                <a href="Index_Admin.html"
                    class="d-flex mb align-items-center justify-content-center link-dark text-decoration-none">
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="container-form-admin">
                                ...
                                <form action="../InicioSesión/Categoria.php" method="POST" enctype="multipart/form-data"
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-4">
                                                <div class="form-group label-floating">
                                                    ...
                                                    <input class="input" type="text" required maxlength="30"
                                                        name="categ-code" placeholder="Codigo Requerido">
                                                </div>
                                            </div>
                                            <br>
                                            <br>
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-4">
                                                <div class="form-group label-floating">
                                                    ...
                                                    <input type="text" class="form-control" required maxlength="30"
                                                        name="categ-name" placeholder="Nombre Requerido">
                                                </div>
                                            </div>
                                            <br>
                                            <br>
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-4">
                                                <div class="form-group label-floating">
                                                    ...
                                                    <input type="text" class="form-control" required name="categ-descrip"
                                    ...
                                    <p class="text-center"><button type="submit"
                                            class="btn btn-primary btn-raised">Agregar Categoria</button></p>
                                </form>
                            </div>
                        </div>
                    </div>
